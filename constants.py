...
RESPONCE_ATTENDANCE_SPECIAL = [
    ...
    "ひよこが出勤申請時刻をお知らせします",
    "アテンドです",
    "今日も1000行のdiffをApproveするか",
    "出勤申請って、嫌だーーーーーーーーーーーーーーーーーーーーーーーーーーーー！！！！！！！！！！！！！！！！！！！！！！！！！！！",
]
...
RESPONCE_LEAVE_SPECIAL = [
    ...
    "ブドウの花言葉: 忘却",
    "今日もtypoを直して一日が終わったね",
    "退勤申請を行ってください。まあ、残業してもいいけどね…………",
    "お疲れ様だなんて言ってあげないんだからねッ",
    "インデントは直した？タイポはない？それでは退勤申請を行ってください。",
]
...
RESPONSE_OVERWORK = [
    ...
    "すなーーー",
    "すなーーーーーーーー！！！！！",
    "会社に泊まれーーーーーーーーーーーーーーーーーーーー！！！！！！！！！",
    "御社に貢献しろーーーーーーーーーーーーーーーーーーーーーーーーーーー！！！！！！！！！！！！"
]
